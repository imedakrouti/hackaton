      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Liste Roles</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
              <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                <li class="breadcrumb-item"><a href="{{ route('dashboard.welcome') }}">  <i class="ni ni-shop "></i></a></li>
                <li class="breadcrumb-item"><a href="">Roles</a></li>
                <li class="breadcrumb-item active" aria-current="page">Liste Roles</li>
              </ol>
            </nav>
          </div>
        ...
        <div class="card-header border-0">
          <div class="row align-items-center">
            ...
            <div class="col text-right">
              <a href="{{ route('dashboard.role.create') }}" class="btn btn-sm btn-primary">Ajouter Role </a>
            </div>
            ...
            <tbody>
                @foreach ($roles as $index=>$role )
                  ...
                  <td class="table-actions">
                    <a href="{{ route('dashboard.role.edit',$role->id) }}" class="table-action" data-toggle="tooltip" data-original-title="Modifier role">
                   ...
                   {{--  <a href="#!" class="table-action" data-toggle="tooltip" data-original-title="Supprimer role">
                    ...
                    <form method="post" action="{{ route('dashboard.role.destroy', $role->id) }}"style="display: inline-block">
                      ...
                      @method('delete')
                        ...
                        <i class="fas fa-trash text-danger delete "style="cursor:pointer" data-id="{{$role->id}}"></i>
