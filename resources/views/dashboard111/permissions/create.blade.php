      ...
      <div class="card">
        <div class="card-header">
          <div class="row align-items-center">
            <div class="col">
              <h3 class="mb-0">Ajouter Permission</h3>
            </div>
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.permission.store') }}" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" name="name"class="form-control @error('name') is-invalid @enderror" id="exampleFormControlInput1" placeholder="Nom Permission" value={{ old('name') }}>
                @error('name')
