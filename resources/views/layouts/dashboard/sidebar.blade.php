    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item ">
                <a class="nav-link {{ request()->routeIs('dashboard.welcome') ? 'active' : '' }}" href="{{ route('dashboard.welcome') }}">
            ...
            <li class="nav-item">
              <a class="nav-link {{ request()->routeIs('dashboard.permission.*') ? 'active' : '' }}" href="#navbar-permissions" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-permissions">
                <i class="ni ni-ungroup text-orange"></i>
                <span class="nav-link-text">Permission</span>
              </a>
              <div class="collapse {{ request()->routeIs('dashboard.permission.*') ? 'show' : '' }}" id="navbar-permissions">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="{{ route('dashboard.permission.index') }}" class="nav-link {{ request()->routeIs('dashboard.permission.index') ? 'active' : '' }}">Liste Permissions</a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('dashboard.permission.create') }}" class="nav-link">Ajouter Permission</a>
                  </li>
            ...
            <li class="nav-item">
              <a class="nav-link {{ request()->routeIs('dashboard.role.*') ? 'active' : '' }}" href="#navbar-roles" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-roles">
                <i class="ni ni-ungroup text-orange"></i>
                <span class="nav-link-text">Roles</span>
              </a>
              <div class="collapse {{ request()->routeIs('dashboard.role.*') ? 'show' : '' }}" id="navbar-roles">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="{{ route('dashboard.role.index') }}" class="nav-link {{ request()->routeIs('dashboard.role.index') ? 'active' : '' }}">Liste Roles</a>
                  </li>
                  <li class="nav-item">
                    <a href="../../pages/examples/login.html" class="nav-link">Ajouter Role</a>
                  </li>
                  <li class="nav-item">
