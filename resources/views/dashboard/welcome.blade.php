...
@endif  --}}
		...
		<script src="{{asset('admin_panel/assets/plugins/jquery-sparkline/jquery.sparkline.min.js')}}"></script>

	<!--Internal  Flot js-->
    <script src="{{ asset('admin_panel/assets/plugins/jquery.flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('admin_panel/assets/plugins/jquery.flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('admin_panel/assets/plugins/jquery.flot/jquery.flot.resize.js')}}"></script>
    <script src="{{ asset('admin_panel/assets/plugins/jquery.flot/jquery.flot.categories.js') }}"></script>
    <script src="{{ asset('admin_panel/assets/js/dashboard.sampledata.js') }}"></script>
    <script src="{{ asset('admin_panel/assets/js/chart.flot.sampledata.js') }}"></script>
	 
	<!--Internal Apexchart js-->

    <script src="{{ asset('admin_panel/assets/js/apexcharts.js') }}"></script>
	 <!-- Internal Map -->
	 
    <script src="{{ asset('admin_panel/assets/plugins/jqvmap/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('admin_panel/assets/plugins/jqvmap/maps/jquery.vmap.usa.js') }}"></script>
	<!--Internal  index js -->
	<script src="{{asset('admin_panel/assets/js/index-dark.js')}}"></script>
